#!/bin/bash
STANDALONE_BUILD_REPO="https://github.com/zotero/zotero-standalone-build.git"
STANDALONE_BUILD_DIR="$SCRIPT_DIR/zotero-standalone-build"

ZOTERO_BUILD_REPO="https://github.com/zotero/zotero-build.git"
ZOTERO_BUILD_DIR="$SCRIPT_DIR/zotero-build"

CONNECTORS_REPO="https://github.com/zotero/zotero-connectors.git"
CONNECTORS_DIR="$SCRIPT_DIR/zotero-connectors"

TRANSLATORS_REPO="https://github.com/zotero/translators.git"
